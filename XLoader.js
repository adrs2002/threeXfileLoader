    ...
    readAnimationKey() {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            if (nowKeyType != 4) {
                ...
                switch (nowKeyType) {
                    case 0:
                        frameM.makeRotationFromQuaternion(new THREE.Quaternion(parseFloat(frameValue[3]), parseFloat(frameValue[0]), parseFloat(frameValue[1]), parseFloat(frameValue[2])));
